...
export const Route = createFileRoute("/obras")({
  head: () => ({ meta: [
    { title: "Obras — Ruan Dornellas" }, { name: "description", content: "Seleção de pinturas e trabalhos de Ruan Dornellas." },
    { property: "og:title", content: "Obras — Ruan Dornellas" }, { property: "og:description", content: "Seleção de pinturas e trabalhos do artista." },
